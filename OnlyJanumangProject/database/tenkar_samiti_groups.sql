-- phpMyAdmin SQL Dump
-- Table structure for table `tenkar_samiti_groups`
--
...
CREATE TABLE `tenkar_samiti_groups` (
  `id` int(11) NOT NULL,
  `serial_no` varchar(50) DEFAULT NULL COMMENT 'क्र.',
  `year` varchar(10) DEFAULT NULL COMMENT 'वर्ष',
  `tenkar_samiti_name` varchar(200) DEFAULT NULL COMMENT 'तेंकार समिति नाम',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Tenkar Samiti Groups/Locations (तेंकार समिति)';

--
-- Indexes for table `tenkar_samiti_groups`
--
...
--
-- AUTO_INCREMENT for table `tenkar_samiti_groups`
--
ALTER TABLE `tenkar_samiti_groups`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- Constraints for table `tenkar_samiti_groups`
--
ALTER TABLE `tenkar_samiti_groups`
  ADD CONSTRAINT `fk_tenkar_samiti_groups_block` FOREIGN KEY (`block`) REFERENCES `block` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_tenkar_samiti_groups_booth` FOREIGN KEY (`booth_name`) REFERENCES `booth` (`id`) ON DELETE SET NULL;
