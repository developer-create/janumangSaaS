-- Table structure for table `booth_samiti_groups`

CREATE TABLE `booth_samiti_groups` (
  `id` int(11) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Booth Samiti Groups/Locations (बूथ समिति)';

--
-- Indexes for table `booth_samiti_groups`
--
...
--
-- AUTO_INCREMENT for table `booth_samiti_groups`
--
ALTER TABLE `booth_samiti_groups`
