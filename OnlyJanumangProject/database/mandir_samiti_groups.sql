-- Table structure for table `mandir_samiti_groups`

CREATE TABLE `mandir_samiti_groups` (
  `id` int(11) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Mandir Samiti Groups/Locations (मंदिर समिति)';

--
-- Indexes for table `mandir_samiti_groups`
--
ALTER TABLE `mandir_samiti_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `block` (`block`),
  ADD KEY `booth_name` (`booth_name`);

--
-- AUTO_INCREMENT for table `mandir_samiti_groups`
--
ALTER TABLE `mandir_samiti_groups`
