            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit निर्माण (सीसी रोड, पुलिया) कार्य समिति Details</h3>
                    </div>
                    <form action="<?php echo site_url('nirmansamiti/update/'.$record['id']); ?>" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-4">
