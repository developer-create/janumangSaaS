        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-warning">
                    ...
                    <form role="form" action="<?php echo site_url('nirmansamiti/update_member/'.$member['id']); ?>" method="post">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?php echo site_url('nirmansamiti/members/'.$member['group_id']); ?>" class="btn btn-default">
