            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Add New निर्माण समिति (Nirman Samiti)</h3>
                    </div>
                    <form action="<?php echo site_url('nirmansamiti/store'); ?>" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="unique_id">Unique ID:</label>
                                        <input type="text" class="form-control" id="unique_id" value="Will be auto-generated" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="sector" name="sector" value="<?php echo set_value('sector'); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="micro_sector_no" name="micro_sector_no" value="<?php echo set_value('micro_sector_no'); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="micro_sector_name">माइक्रो सेक्टर नाम (Micro Sector Name):</label>
                                        <input type="text" class="form-control" id="micro_sector_name" name="micro_sector_name" value="<?php echo set_value('micro_sector_name'); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="booth_no" name="booth_no" value="<?php echo set_value('booth_no'); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="gram_panchayat">ग्राम पंचायत (Gram Panchayat):</label>
                                        <input type="text" class="form-control" id="gram_panchayat" name="gram_panchayat" value="<?php echo set_value('gram_panchayat'); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="faliya" name="faliya" value="<?php echo set_value('faliya'); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?php echo site_url('nirmansamiti'); ?>" class="btn btn-default">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    $('#block').change(function() {
        ...
        if (blockId) {
            $.ajax({
                url: '<?php echo base_url(); ?>nirmansamiti/get_booths_by_block',
                type: 'POST',
    ...
    $('#booth_name').change(function() {
        ...
        if (boothId) {
            $.ajax({
                url: '<?php echo base_url(); ?>nirmansamiti/get_booth_details',
                type: 'POST',
