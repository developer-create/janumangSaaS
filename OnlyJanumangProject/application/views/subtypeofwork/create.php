            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Subtype Of Work Details</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="<?php echo site_url('subtypeofwork/store'); ?>" method="post">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="work_type_id" name="work_type_id" required>
                                            ...
                                            <?php foreach ($worktypes as $worktype): ?>
                                                <option value="<?php echo $worktype['id']; ?>" <?php echo set_select('work_type_id', $worktype['id']); ?>>
