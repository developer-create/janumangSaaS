<div class="content-wrapper">
    <section class="content-header">
      <h1>
        <i class="fa fa-edit" aria-hidden="true"></i> Edit Inward Register
      </h1>
    </section>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Edit Register - <?php echo $register['unique_id']; ?></h3>
                </div>
                <div class="box-body">
                    ...
                    <?php echo form_open('inwardregister/update/' . $register['id']); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="issue_no" name="issue_no" placeholder="Enter issue number" 
                                    value="<?php echo set_value('issue_no', $register['issue_no']); ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="issue_date" name="issue_date" 
                                    value="<?php echo set_value('issue_date', $register['issue_date']); ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="letter_name" name="letter_name" placeholder="Enter letter name" 
                                    value="<?php echo set_value('letter_name', $register['letter_name']); ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="letter_received_date" name="letter_received_date" 
                                    value="<?php echo set_value('letter_received_date', $register['letter_received_date']); ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="from_whom_received" name="from_whom_received" rows="3" placeholder="Enter sender details" required><?php echo set_value('from_whom_received', $register['from_whom_received']); ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="received_letter_description" name="received_letter_description" rows="3" placeholder="Enter letter description" required><?php echo set_value('received_letter_description', $register['received_letter_description']); ?></textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="received_letter_number" name="received_letter_number" placeholder="Enter received letter number" 
                                    value="<?php echo set_value('received_letter_number', $register['received_letter_number']); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="received_letter_date" name="received_letter_date" 
                                    value="<?php echo set_value('received_letter_date', $register['received_letter_date']); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="received_letter_attachment" name="received_letter_attachment" placeholder="Enter attachment details" 
                                    value="<?php echo set_value('received_letter_attachment', $register['received_letter_attachment']); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="reply_to_number" name="reply_to_number" placeholder="Enter reply number" 
                                    value="<?php echo set_value('reply_to_number', $register['reply_to_number']); ?>">
                            </div>

                            <div class="form-group">
                                <label for="reply_to_date">दिनांक / Reply To Date</label>
                                <input type="date" class="form-control" id="reply_to_date" name="reply_to_date" 
                                    value="<?php echo set_value('reply_to_date', $register['reply_to_date']); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="our_reply_number" name="our_reply_number" placeholder="Enter our reply number" 
                                    value="<?php echo set_value('our_reply_number', $register['our_reply_number']); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="our_reply_date" name="our_reply_date" 
                                    value="<?php echo set_value('our_reply_date', $register['our_reply_date']); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="forwarded_letter_number" name="forwarded_letter_number" placeholder="Enter forwarded letter number" 
                                    value="<?php echo set_value('forwarded_letter_number', $register['forwarded_letter_number']); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="forwarded_letter_date" name="forwarded_letter_date" 
                                    value="<?php echo set_value('forwarded_letter_date', $register['forwarded_letter_date']); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="subject" name="subject" rows="3" placeholder="Enter subject" required><?php echo set_value('subject', $register['subject']); ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="file_number" name="file_number" placeholder="Enter file number" 
                                    value="<?php echo set_value('file_number', $register['file_number']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="sent_to" name="sent_to" placeholder="Enter recipient name/department" 
                                    value="<?php echo set_value('sent_to', $register['sent_to']); ?>">
                            </div>

                            <div class="form-group">
                                <label for="remarks">Remarks / टिप्पणी</label>
                                <textarea class="form-control" id="remarks" name="remarks" rows="3" placeholder="Enter remarks"><?php echo set_value('remarks', $register['remarks']); ?></textarea>
                            </div>
                        </div>
                    </div>
