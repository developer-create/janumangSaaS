<div class="content-wrapper">
    ...
    <section class="content-header"> 
        <h1>
            <i class="fa fa-users" aria-hidden="true"></i> Booth Samiti Members
        </h1>
    </section>
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo site_url('boothsamiti/add_member/'.$group['id']); ?>" class="btn btn-success">
                                <i class="fa fa-plus"></i> Add Member
                            </a>
                            <a href="<?php echo site_url('boothsamiti'); ?>" class="btn btn-default">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('boothsamiti/edit_member/'.$member['id']); ?>" class="btn btn-warning btn-xs" title="Edit">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a href="<?php echo site_url('boothsamiti/delete_member/'.$member['id']); ?>" class="btn btn-danger btn-xs" title="Delete" onclick="return confirm('Are you sure you want to delete this member?');">
        ...
        "buttons": [
            {
                extend: 'excelHtml5',
                text: 'Export Excel',
                title: 'Booth Samiti Members - <?php echo $group['block_name']; ?> - <?php echo $group['village']; ?>',
                exportOptions: {
