            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">बूथ समिति (Booth Samiti) Details</h3>
                        <div class="box-tools">
                            <a href="<?php echo site_url('boothsamiti'); ?>" class="btn btn-default btn-sm">
                                <i class="fa fa-arrow-left"></i> Back to List
                            </a>
                            <a href="<?php echo site_url('boothsamiti/edit/'.$record['id']); ?>" class="btn btn-warning btn-sm">
