            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit कबड्डी समिति (Kabbadi Samiti)</h3>
                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="booth_dropdown" name="booth_name" required>
                                            ...
                                            <?php foreach ($booths as $booth): ?>
                                                <option value="<?php echo $booth->id; ?>" <?php echo ($record['booth_name'] == $booth->id) ? 'selected' : ''; ?>><?php echo $booth->name; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
