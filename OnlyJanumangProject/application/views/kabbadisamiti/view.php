<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-info-circle" aria-hidden="true"></i> View Khel Samiti Details
        </h1>
    </section>
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <p><strong>Block:</strong> <?php echo isset($group['block_name']) ? $group['block_name'] : $group['block']; ?></p>
                            </div>
                            <div class="col-md-4">
