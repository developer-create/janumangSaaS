            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Add New खेल समिति (Khel Samiti) Location</h3>
                    </div>
...
$(document).ready(function() {
    ...
    $('#btnSaveSamitiType').on('click', function() {
        ...
        if (!name) {
            $('#samiti_type_error').html('Name is required.');
            return;
        }
        $.ajax({
            ...
            success: function(res) {
                if (res.error) {
                    $('#samiti_type_error').html(res.message || 'Error');
                    return;
                }
