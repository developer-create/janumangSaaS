<div class="content-wrapper">
    ...
    <section class="content-header"> 
        <h1>
            <i class="fa fa-users" aria-hidden="true"></i> DP Samiti Members
        </h1>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-3">
                                <strong>ब्लॉक (Block):</strong> <?php echo isset($groupInfo->block_name) ? $groupInfo->block_name : 'N/A'; ?>
                                <!-- Debug: Block ID = <?php echo $groupInfo->block; ?> -->
                            </div>
                            <div class="col-md-3">
                                <strong>सेक्टर (Sector):</strong> <?php echo $groupInfo->sector; ?>
                            </div>
                            <div class="col-md-3">
                                <strong>बूथ का नाम (Booth Name):</strong> <?php echo $groupInfo->booth_name_text; ?>
                            </div>
                            <div class="col-md-3">
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo base_url().'dpsamiti/addMember/'.$groupInfo->id; ?>" class="btn btn-success">
                                <i class="fa fa-plus"></i> Add Member
                            </a>
                            <a href="<?php echo base_url().'dpsamiti'; ?>" class="btn btn-default">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url().'dpsamiti/editMember/'.$record->id; ?>" class="btn btn-warning btn-xs" title="Edit">
...
$(document).ready(function() {
        ...
        "buttons": [
            {
                extend: 'excelHtml5',
                text: 'Export Excel',
                title: 'DP Samiti Members - <?php echo $groupInfo->block_name; ?> - <?php echo $groupInfo->village; ?>',
                exportOptions: {
    ...
    $(document).on("click", ".deleteMember", function(){
        ...
        {
            window.location.href = "<?php echo base_url(); ?>dpsamiti/deleteMember/" + memberId + "/" + groupId;
        }
        return false;
    });
});
