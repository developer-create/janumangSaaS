<div class="content-wrapper">
    ...
    <section class="content-header"> 
        <h1>
            <i class="fa fa-users" aria-hidden="true"></i> Boring Samiti Members
        </h1>
    </section>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row" style="margin-top: 10px;">
                            ...
                            <div class="col-md-3">
                                <strong>बोरिंग समिति नाम (Boring Samiti Name):</strong> <?php echo $group['boring_samiti_name']; ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo site_url('boringsamiti/add_member/'.$group['id']); ?>" class="btn btn-success">
                                <i class="fa fa-plus"></i> Add Member
                            </a>
                            <a href="<?php echo site_url('boringsamiti'); ?>" class="btn btn-default">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('boringsamiti/edit_member/'.$member['id']); ?>" class="btn btn-warning btn-xs" title="Edit Member">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a href="<?php echo site_url('boringsamiti/delete_member/'.$member['id']); ?>" class="btn btn-danger btn-xs" title="Delete Member" onclick="return confirm('Are you sure you want to delete this member?');">
        ...
        "buttons": [
            {
                extend: 'excelHtml5',
                text: 'Export Excel',
                title: 'Boring Samiti Members List',
                exportOptions: {
