...
<div class="content-wrapper">
    ...
    <section class="content-header"> 
      <h1>
        <i class="fa fa-user-circle-o" aria-hidden="true"></i> worktype Management
      </h1>
    </section>
    <section class="content"> 
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">worktype List</h3>  
                    <a href="<?php echo site_url('worktype/create'); ?>"  class="btn btn-success"  style="float: right;">Add New worktype</a>
        ...
        <tr>
            <td><?php echo $worktype['id']; ?></td>
            <td><?php echo $worktype['name']; ?></td>
            <td>
                <a href="<?php echo site_url('worktype/edit/'.$worktype['id']); ?>"  class="btn btn-info"><i class="fa fa-pencil"></i></a>
                <a href="<?php echo site_url('worktype/delete/'.$worktype['id']); ?>"  class="btn btn-danger" onclick="return confirm('Are you sure?');"><i class="fa fa-trash"></i></a>
            </td>
        </tr>
        <?php endforeach; ?>
        </tbody>
