<div class="content-wrapper">
    ...
    <section class="content-header"> 
        <h1>
            <i class="fa fa-users" aria-hidden="true"></i> Tenkar Samiti Members
        </h1>
    </section>
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo site_url('tenkarsamiti/add_member/'.$group['id']); ?>" class="btn btn-success">
                                <i class="fa fa-plus"></i> Add Member
                            </a>
                            <a href="<?php echo site_url('tenkarsamiti'); ?>" class="btn btn-default">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('tenkarsamiti/edit_member/'.$member['id']); ?>" class="btn btn-warning btn-xs" title="Edit Member">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a href="<?php echo site_url('tenkarsamiti/delete_member/'.$member['id']); ?>" class="btn btn-danger btn-xs" title="Delete Member" onclick="return confirm('Are you sure you want to delete this member?');">
        ...
        "buttons": [
            {
                extend: 'excelHtml5',
                text: 'Export Excel',
                title: 'Tenkar Samiti Members List',
                exportOptions: {
