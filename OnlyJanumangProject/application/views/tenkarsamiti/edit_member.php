        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-warning">
                    ...
                    <form role="form" action="<?php echo site_url('tenkarsamiti/update_member/'.$member['id']); ?>" method="post">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?php echo site_url('tenkarsamiti/members/'.$member['group_id']); ?>" class="btn btn-default">
