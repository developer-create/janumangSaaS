<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-file-text" aria-hidden="true"></i> Add New In Doc (जावक दस्तावेज़)
            <small>Register a new incoming document</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <?php echo form_open('indocs/store', array('class' => 'form-horizontal')); ?>
                    <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="issue_no" name="issue_no" 
                                               value="<?php echo set_value('issue_no'); ?>" required maxlength="100"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="date" class="form-control" id="month_date" name="month_date" 
                                               value="<?php echo set_value('month_date'); ?>" required>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <!-- Row 2: Name & Address & Place -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="name_address" name="name_address" rows="3" 
                                                  required placeholder="Complete name and address"><?php echo set_value('name_address'); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="place" name="place" 
                                               value="<?php echo set_value('place'); ?>" maxlength="255"
                                               placeholder="Place">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="subject" name="subject" 
                                               value="<?php echo set_value('subject'); ?>" required maxlength="255"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" id="documents_count" name="documents_count" 
                                               value="<?php echo set_value('documents_count'); ?>" min="0"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="reference_issue_no" name="reference_issue_no" 
                                               value="<?php echo set_value('reference_issue_no'); ?>" maxlength="255"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="received_issue_no" name="received_issue_no" 
                                               value="<?php echo set_value('received_issue_no'); ?>" maxlength="255"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="file_head_no" name="file_head_no" 
                                               value="<?php echo set_value('file_head_no'); ?>" maxlength="100"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" id="stamp_received" name="stamp_received" 
                                               value="<?php echo set_value('stamp_received'); ?>" min="0" step="0.01"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="remarks" name="remarks" rows="4" 
                                                  placeholder="Additional remarks"><?php echo set_value('remarks'); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-save"></i> Save In Doc Record
                                </button>
