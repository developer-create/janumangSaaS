        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-warning">
                    ...
                    <form role="form" action="<?php echo site_url('ganeshsamiti/update_member/'.$member['id']); ?>" method="post">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="father_name" name="father_name" value="<?php echo $member['father_name']; ?>" placeholder="Enter Father Name">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?php echo site_url('ganeshsamiti/members/'.$member['group_id']); ?>" class="btn btn-default">
