            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Add New गणेश समिति (Ganesh Samiti)</h3>
                    </div>
                    <form action="<?php echo site_url('ganeshsamiti/store'); ?>" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="unique_id_preview">Unique ID:</label>
                                        <input type="text" class="form-control" id="unique_id_preview" value="Auto Generated (GS/X)" readonly style="background-color: #f5f5f5; color: #999;">
...
$(document).ready(function() {
    ...
    $.ajax({
        url: '<?php echo base_url(); ?>ganeshsamiti/next_unique_id',
        type: 'GET',
        dataType: 'json',
    ...
    $('#block').change(function() {
        ...
        if (blockId) {
            $.ajax({
                url: '<?php echo base_url(); ?>ganeshsamiti/get_booths_by_block',
                type: 'POST',
    ...
    $('#booth_name').change(function() {
        ...
        if (boothId) {
            $.ajax({
                url: '<?php echo base_url(); ?>ganeshsamiti/get_booth_details',
                type: 'POST',
