        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo site_url('ganeshsamiti/store_member'); ?>" method="post">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?php echo site_url('ganeshsamiti/members/'.$group['id']); ?>" class="btn btn-default">
