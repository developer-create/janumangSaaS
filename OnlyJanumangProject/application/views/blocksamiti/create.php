            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Add New ब्लॉक समिति (Block Samiti)</h3>
                    </div>
                    <form action="<?php echo site_url('blocksamiti/store'); ?>" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="unique_id_preview">Unique ID:</label>
                                        <input type="text" class="form-control" id="unique_id_preview" value="Auto Generated (BL/X)" readonly style="background-color: #f5f5f5; color: #999;">
