<div class="content-wrapper">
    ...
    <section class="content-header"> 
        <h1>
            <i class="fa fa-users" aria-hidden="true"></i> Block Samiti Members
        </h1>
    </section>
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo site_url('blocksamiti/add_member/'.$group['id']); ?>" class="btn btn-success">
                                <i class="fa fa-plus"></i> Add Member
                            </a>
                            <a href="<?php echo site_url('blocksamiti'); ?>" class="btn btn-default">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('blocksamiti/edit_member/'.$member['id']); ?>" class="btn btn-warning btn-xs" title="Edit">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a href="<?php echo site_url('blocksamiti/delete_member/'.$member['id']); ?>" class="btn btn-danger btn-xs" title="Delete" onclick="return confirm('Are you sure you want to delete this member?');">
        ...
        "buttons": [
            {
                extend: 'excelHtml5',
                text: 'Export Excel',
                title: 'Block Samiti Members - <?php echo $group['block_name']; ?> - <?php echo $group['village']; ?>',
                exportOptions: {
