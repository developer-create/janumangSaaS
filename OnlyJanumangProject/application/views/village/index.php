            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="<?php echo site_url('village/create'); ?>" class="btn btn-success"  style="float: right;">Add New Village</a>
                    </div>
                    <div class="box-body">
                        <table id="feedbackTa" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $village['panchayat_name']; ?></td>
                                    <td><?php echo $village['booth_name']; ?></td>
                                    <td><?php echo $village['block_name']; ?></td>
                                    <td>
                                        <a href="<?php echo site_url('village/edit/'.$village['id']); ?>" class="btn btn-info"><i class="fa fa-pencil"></i></a>
                                        <a href="<?php echo site_url('village/delete/'.$village['id']); ?>" 
                                        class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this village?');"><i class="fa fa-trash"></i></a>
                                    </td>
