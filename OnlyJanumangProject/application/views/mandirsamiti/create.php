            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Add New मंदिर समिति (Mandir Samiti)</h3>
                    </div>
                    
                    <form action="<?php echo site_url('mandirsamiti/store'); ?>" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-4">
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?php echo site_url('mandirsamiti'); ?>" class="btn btn-default">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
