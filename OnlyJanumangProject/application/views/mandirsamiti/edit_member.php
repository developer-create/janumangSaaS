        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>mandirsamiti/updateMember" method="post">
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?php echo base_url().'mandirsamiti/members/'.$memberInfo->group_id; ?>" class="btn btn-default">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
