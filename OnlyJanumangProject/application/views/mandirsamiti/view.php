                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <a href="<?php echo base_url().'mandirsamiti/members/'.$groupInfo->id; ?>" class="btn btn-sm btn-info">
                                <i class="fa fa-users"></i> View Members
                            </a>
                            <a href="<?php echo base_url().'mandirsamiti/edit/'.$groupInfo->id; ?>" class="btn btn-sm btn-primary">
                                <i class="fa fa-pencil"></i> Edit
                            </a>
                            <a href="<?php echo base_url().'mandirsamiti'; ?>" class="btn btn-sm btn-default">
