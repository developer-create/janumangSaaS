...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Vibhag Management
      </h1>
    </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Vibhag  List</h3>
                <a href="<?php echo base_url() ?>user/vibhagadd" class="btn btn-info btn-sm pull-right  ">Add New Department</a>
                    ...
                    <tr>
                        ...
                        <td><?php echo $record->created_at; ?></td> 
                         ...
                         <td style="width: 150px !important;"  class="text-center">
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'user/deprtedit/'.$record->id; ?>" title="Edit"><i class="fa fa-edit" aria-hidden="true"></i></a>
                            <a class="btn btn-sm btn-danger" href="<?php echo base_url().'user/departdelete/'.$record->id; ?>" 
                            title="Delete"
