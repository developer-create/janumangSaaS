      ...
      <div class="row">
         ...
         <div class="col-xs-12">
            <form method="post" action="<?php echo base_url(
               "Districtpublicproblem/Disctrictproblem"
               ); ?>">
               <div class="row">
                  <div class="col-md-2">
                     <div class="form-group">
                        ...
                        <select name="block" id="block" class="form-control">
                           ...
                           <?php
                              ...
                              $selected_block = isset($filters['block']) ? $filters['block'] : '';
                              //  $this->db->where('id !=', 6);
                              if ($sessionBlockId != 0) {
                              ...
                              foreach ($blocks as $blk) {
                                  $selected = ($selected_block == $blk->id) ? 'selected' : '';
                  ...
                  <div class="col-md-2">
                     <div class="form-group">
                        ...
                        <select name="year" id="year" class="form-control">
                           ...
                           <?php
                              $selected_year = isset($filters['year']) ? $filters['year'] : '';
                              // Generate financial year options
                              $current_year = date("Y");
                              for ($i = $current_year; $i >= $current_year - 5; $i--) {
                                  $fin_year = $i . '-' . substr($i + 1, -2);
                                  $selected = ($selected_year == $fin_year) ? 'selected' : '';
                                  echo "<option value='{$fin_year}' {$selected}>{$fin_year}</option>";
                              }
                              ?>
                        </select>
                     </div>
                  ...
                  <div class="col-md-2">
                     <div class="form-group">
                        ...
                        <select name="month" id="month" class="form-control">
                           ...
                           <?php
                              $selected_month = isset($filters['month']) ? $filters['month'] : '';
                              $months = [
                                  "01" => "January",
                                  "02" => "February",
                                  "03" => "March",
                     ...
                     <div class="form-group">
                        ...
                        <select name="department" id="department" class="form-control">
                           ...
                           <?php
                              ...
                              $selected_dept = isset($filters['department']) ? $filters['department'] : '';
                              foreach ($departments as $dept) {
                                  $selected = ($selected_dept == $dept->id) ? 'selected' : '';
                  ...
                  <div class="col-md-2">
                     <div class="form-group">
                        ...
                        <select name="approved_fund" id="approved_fund" class="form-control">
                           ...
                           <?php
                              $selected_fund = isset($filters['approved_fund']) ? $filters['approved_fund'] : '';
                              $fund_options = ['MLA FUND', 'MLA Swechanudan', 'CLP Swechanudan', 'Jansampark Fund'];
                              foreach ($fund_options as $fund) {
                                  $selected = ($selected_fund == $fund) ? 'selected' : '';
            ...
            <div class="box">
               <div class="box-header">
                  ...
                  <a href="<?php echo base_url(); ?>Districtpublicproblem/addNewDisctrictproblem"  class="btn btn-info" style="float: right;" >Add</a>
               </div>
               <!-- /.box-header -->
                  ...
                  <table id="feedbackTa" class="table table-striped" style="width:100%">
                     <thead>
                        <tr style="color:white;font-size:15px;background-color:#020254;">
                           ...
                           <!--<th>PO</th>-->
                           <th>Status</th>
                           <th style="width:200px !important;">Remark/ GOSHANA <br> </th>
                     ...
                     <tbody>
                        ...
                        <tr class="clickable-row" data-id="<?php echo $record->id; ?>" data-stage="1" style="cursor: pointer;">
                           ...
                           <td><?php echo !empty($record->booth_number) ? $record->booth_number : $record->booth_no; ?></td>
                           ...
                           <td>
                              <?php 
                              if ($record->approved_fund == 'others') {
                                  echo !empty($record->approved_fund_other) ? $record->approved_fund_other : 'Others';
                              } else {
                                  echo !empty($record->approved_fund) ? $record->approved_fund : '-';
                              }
                              ?>
                           </td>
                           ...
                           <td class="text-center">
                              <a class="btn btn-sm btn-info" href="<?php echo base_url() .
                                 "Districtpublicproblem/Disctrictproblemcommentview/" .
                                 $record->id; ?>" title="View Comments"><i class="fa fa-eye" aria-hidden="true"></i></a>
                              <a class="btn btn-sm btn-success "    href="<?php echo base_url() .
                                 "Districtpublicproblem/submit_form/" .
    ...
    <div class="modal-dialog modal-lg" role="document" style="width: 90%; max-width: 1200px;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="recordModalLabel">District Public Problem Details</h4>
            </div>
                        ...
                        <div class="panel-body">
                            <form id="commentForm" enctype="multipart/form-data">
                                ...
                                <div class="form-group" style="padding: 0 15px;">
                                    ...
                                    <textarea class="form-control" id="commentText" name="comment" rows="4" required placeholder="Enter your comment here..."></textarea>
                                </div>
...
$(document).ready(function() {
    ...
    function loadRecordDetails(id) {
        ...
        $.ajax({
            url: '<?php echo base_url("Districtpublicproblem/get_districtpublicproblem_details/"); ?>' + id,
            type: 'GET',
            dataType: 'json',
            ...
            error: function() {
                $('#recordData').html('<div class="alert alert-danger">Error loading data</div>');
                $('#commentsList').html('');
            }
        });
    }
    ...
    function displayRecordData(record) {
        ...
        if (record.work_status == "Complete") {
            ...
            statusBadge = '<span class="label label-default">' + (record.work_status || 'Unknown') + '</span>';
        }
        
        // Use joined names if available, otherwise raw values
        var bNo = record.booth_number || record.booth_no || 'N/A';
        var bName = record.booth_name_joined || record.booth_name || 'N/A';
        var pName = record.panchayat_name_joined || record.panchayat_name || 'N/A';
        var vName = record.village_name_joined || record.village || 'N/A';

        var html = '<div class="col-md-12">' +
            '<div class="col-md-6"><strong>Registration No:</strong> ' + (record.registration_no || 'N/A') + '</div>' +
            '<div class="col-md-6"><strong>Financial Year:</strong> ' + (record.year || 'N/A') + '</div>' +
            '<div class="col-md-6"><strong>Month:</strong> ' + (record.month || 'N/A') + '</div>' +
            ...
            '<div class="col-md-6"><strong>Booth No:</strong> ' + bNo + '</div>' +
            '<div class="col-md-6"><strong>Booth Name:</strong> ' + bName + '</div>' +
            '<div class="col-md-6"><strong>Panchayat Name:</strong> ' + pName + '</div>' +
            '<div class="col-md-6"><strong>Village:</strong> ' + vName + '</div>' +
            ...
            '<div class="col-md-6"><strong>Approved Fund:</strong> ' + (record.approved_fund == 'others' ? record.approved_fund_other : record.approved_fund || 'N/A') + '</div>' +
            '<div class="col-md-6"><strong>Work Agency:</strong> ' + (record.work_agency || 'N/A') + '</div>' +
            ...
            '<div class="col-md-6"><strong>Mobile:</strong> ' + (record.mobile || 'N/A') + '</div>' +
            '<div class="col-md-6"><strong>Lat-Lng:</strong> ' + (record.lat || 'N/A') + ', ' + (record.lng || 'N/A') + '</div>' +
            '<div class="col-md-6"><strong>Created At:</strong> ' + (record.createdAt || 'N/A') + '</div>' +
            '<div class="col-md-6"><strong>Added By:</strong> ' + (record.added_by_name || 'N/A') + '</div>' +
            '<div class="col-md-12" style="margin-top: 10px;"><strong>Work/Problem:</strong><br>' + (record.work_problem || 'N/A') + '</div>' +
            '<div class="col-md-12"><strong>Remark/ GOSHANA:</strong><br>' + (record.remark_goshana || 'N/A') + '</div>' +
            '<div class="col-md-12"><strong>REMARK / TIP/ USD:</strong><br>' + (record.remark || 'N/A') + '</div>';
        
        if (record.uploaded_file) {
            html += '<div class="col-md-12" style="margin-top: 10px;"><strong>Avedan:</strong> <a href="<?php echo base_url(); ?>uploads/' + record.uploaded_file + '" target="_blank" class="btn btn-xs btn-info">View File</a></div>';
        }
    ...
    $('#commentForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo base_url("Districtpublicproblem/add_comment_ajax"); ?>',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    $('#commentForm')[0].reset();
                    displayComments(response.comments);
                    // Reload page to refresh status in main table
                    location.reload();
                } else {
