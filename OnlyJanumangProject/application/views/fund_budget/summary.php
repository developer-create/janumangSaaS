...
<style>
.dt-buttons { float: left; margin-right: 10px; margin-bottom: 10px; }
.dt-button { background-color: #337ab7 !important; color: white !important; border: 1px solid #2e6da4 !important; padding: 6px 12px !important; margin-right: 5px !important; border-radius: 4px !important; font-size: 12px !important; }
.dt-button:hover { background-color: #286090 !important; border-color: #204d74 !important; }
.dt-button.buttons-excel { background-color: #28a745 !important; border-color: #218838 !important; }
.dt-button.buttons-excel:hover { background-color: #218838 !important; }
.dataTables_length { float: left; margin-right: 20px; }
.dataTables_length select { padding: 5px; border: 1px solid #d2d6de; border-radius: 3px; }
.dataTables_filter { float: right; }
.dataTables_wrapper { overflow-x: auto; clear: both; }
table.table th, table.table td { padding: 10px !important; font-size: 13px !important; }
table.dataTable thead>tr>th.sorting:after, table.dataTable thead>tr>th.sorting_asc:after, table.dataTable thead>tr>th.sorting_desc:after { color: #000000 !important; opacity: 0.6 !important; }
table.dataTable thead>tr>th.sorting:before, table.dataTable thead>tr>th.sorting_asc:before, table.dataTable thead>tr>th.sorting_desc:before { color: #000000 !important; opacity: 0.6 !important; }
.dataTables_info { float: left; padding-top: 15px; }
.dataTables_paginate { float: right; padding-top: 0px; }
.paginate_button { padding: 5px 10px !important; margin: 2px !important; border: 1px solid #ddd !important; border-radius: 3px !important; background-color: #ffffff !important; color: #333 !important; cursor: pointer !important; }
.paginate_button:hover { background-color: #f5f5f5 !important; }
.paginate_button.current { background-color: #337ab7 !important; color: white !important; border-color: #2e6da4 !important; }
.paginate_button.disabled { opacity: 0.5; cursor: not-allowed !important; }
.dataTables_paginate { margin-top: 15px; }
.table-hover tbody tr:hover td { background-color: #f5f5f5; }
table#fundSummaryTable:not(.dataTable) tbody { display: none; }
</style>
