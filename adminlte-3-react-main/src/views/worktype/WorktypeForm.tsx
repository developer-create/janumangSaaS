...
import {
  workTypeSchema,
  workTypeInitialValues,
  IWorkTypeFormValues,
} from "./workType.schema";

interface WorktypeFormProps {
  initialValues?: IWorkTypeFormValues;
  onSubmit: (values: IWorkTypeFormValues) => void;
  loading?: boolean;
}

const WorktypeForm = ({
  initialValues = workTypeInitialValues,
  onSubmit,
  loading = false,
}: WorktypeFormProps) => {
  const formik = useFormik<IWorkTypeFormValues>({
    initialValues,
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <div className="grid gap-2">
              ...
              >
                Worktype Name <span className="text-red-500">*</span>
              </Label>
              <Input
                id="name"
                name="name"
